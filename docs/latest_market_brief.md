...
| 虚拟货币 | 比特币 | 64,858.63 | +0.93% | +2.17% | +1.50% | +20.86% | 中性偏强 | 中等 |
| 虚拟货币 | 以太坊 | 1,912.42 | +0.54% | +1.59% | +3.88% | +29.73% | 短线偏强 | 中等 |
| 虚拟货币 | Solana | 73.91 | +1.84% | +0.63% | -1.47% | +27.87% | 中性偏弱 | 中等 |
...
| 宏观变量 | 美元指数 | 99.60 | -0.37% | -0.20% | -1.32% | +4.92% | 震荡/中性 | 中等 |
...
| 美股 | 0.30 | U.S. stock futures gain ahead of Friday's critical labor data, with markets on track for strongest week since April - eciks.org | eciks.org |
